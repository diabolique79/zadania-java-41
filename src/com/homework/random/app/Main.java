...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Sets sets = new Sets();
        System.out.println(sets.randomSet(treeSet));
//        System.out.println("Zbiór wynosi: " + sets.randomSet(treeSet));
        ...
        System.out.println("Średnia arytmetyczna wynosi: "+sets.average(treeSet));

        Integer srednia = sets.average(treeSet);
        System.out.println("Wartości powyżej średniej arytmetycznej ze zbioru wynoszą: " + treeSet.subSet(srednia, treeSet.last() + 1));
